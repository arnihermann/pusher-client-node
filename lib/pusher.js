...
_.extend(Pusher.prototype, {
     ...
     */
    subscribe: function(channelName, channelData){
        var self = this;
        var channelData = channelData || this.config.channel_data;
        var channel = this.channels.add(channelName, channelData, this);
